...
//     phone: '2348134729',
//     location: 'Abu',
//     bio: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis.',
...
//               </div>
//               <div className="flex-1">
//                 <h3 className="text-lg font-semibold text-gray-800 mb-2">Upload New photo</h3>
...
//                 </div>
//               </div>
//               <button className="bg-emerald-500 text-white px-6 py-3 rounded-lg hover:bg-emerald-600 transition-colors font-medium">
//                 Save Changes
//               </button>
//             </div>
//           </div>
...
//               ))}
//             </div>
//             <button className="flex items-center space-x-2 px-4 py-2 text-white bg-emerald-500 rounded-lg hover:bg-emerald-600 transition-colors">
//               <span>Next</span>
...
//             <h3 className="text-lg font-semibold text-gray-800 mb-6">Complete your profile</h3>
